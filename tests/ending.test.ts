...
describe('ending', () => {
  ...
  it('インフラ復旧・少犠牲なら完全復旧', () => {
    const s: GameState = {
      ...base(),
      resources: { ...base().resources, power: 80, medical: 80 },
      flags: { ...base().flags, casualties: 0 },
    }
  ...
  it('インフラ未復旧で協力度高ければ住民自治', () => {
    const s: GameState = {
      ...
      flags: { ...base().flags, casualties: 0, cooperation: 20 },
    }
